...
const serviceData = getServiceBySlug('ai-automation')!
              ...
              <div className="mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {serviceData.useCases.map((useCase, index) => (
                    <div key={index} className="bg-secondary-light p-6 rounded-xl shadow-lg">
                      <h3 className="text-xl font-bold text-primary-dark mb-3">{useCase.title}</h3>
                      <p className="text-primary-dark/70">{useCase.description}</p>
                    </div>
                  ))}
                </div>
              </div>
